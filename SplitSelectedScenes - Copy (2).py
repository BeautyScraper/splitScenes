...
class VideoScene():
    ...
    def __init__(self,sceneVideo,Outvideo,startTime,EndTime):
    ...
    def Merge(self,SecondVS):
        ...
        return VideoScene(self.sceneVideo,self.Outvideo,mstartTime,mendTime)
...
def main():
    ...
    for sceneImageFiles in SelectedFramesDir.glob('*.jp*g'):
        ...
        newVideoSec = VideoScene(sceneVideo,Outvideo,startTime,EndTime)
